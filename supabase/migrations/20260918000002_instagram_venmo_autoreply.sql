-- Auto-reply copy when buyer DMs "Order M#### is placed"
...
begin
  ...
  if p_contact_method = 'instagram' then
    insert into public.instagram_outbox (
      ...
      v_order_id,
      v_instagram,
      'Hii !! Thank you for placing an order with us <3'
        || chr(10) || chr(10)
        || 'To secure the order, please send $' || to_char(v_total, 'FM9990.00')
        || ' to Venmo: @mye-lenses within 24 hours.'
        || chr(10) || chr(10)
        || 'Please add your IG username as the note of the payment!',
